...
### An agentic Security Operations Center that runs entirely on your own hardware
...
[Why](#why-sentigon) · [Features](#what-it-does) · [The console](#the-command-center) · [Quick start](#quick-start) · [Architecture](#architecture) · [Tech](#tech-stack)
...
**Prerequisites:** Python 3.12, Node 20+, [Ollama](https://ollama.com), and a GPU (recommended, not required).
...
<details>
<summary><b>Deep dive — agents, services, and the full feature set</b></summary>
