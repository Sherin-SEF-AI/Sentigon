...
export function CameraGrid({
  ...
  if (cameraCount === 0) {
    return (
      <div className="flex h-64 flex-col items-center justify-center rounded-lg border border-dashed border-border bg-surface-0/50">
        ...
        <p className="text-xs text-muted-foreground font-medium">No camera feeds available</p>
        <p className="text-[10px] text-muted-foreground mt-1">Waiting for camera connections...</p>
      </div>
    );
  }
